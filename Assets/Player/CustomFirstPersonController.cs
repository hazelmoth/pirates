...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class CustomFirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
			...
			m_Animator = transform.Find ("Player Model").GetComponent<Animator> ();
        }
        ...
        private void Update()
		{
			...
			{
				m_Animator.SetFloat ("Walking", Mathf.Max (Mathf.Abs(m_MoveDir.x)/4.0f, Mathf.Abs(m_MoveDir.z)/4.0f));
			}
        }
